...
<body>
	<div>
		...
		<br><br>
		<p class="text">...for more information use dev console to see the comment blocks of my html/js/css roughdraft outlines:</p>
		<br>
		<ul>
			<li><a href="./roughdrafting/index-roughdraft.html">index.html that contains the page layout</a></li>
			<li><a href="./roughdrafting/aboutme-content-roughdraft.html">About Me, Dom inserted html</a></li>
			<li><a href="./roughdrafting/contactform-content-roughdraft.html">Contact, Dom inserted html</a></li>
			<li><a href="./roughdrafting/portfolio-content-roughtdraft.html">portfolio, Dom inserted html</a></li>
			<li><a href="./roughdrafting/resume-content-roughdraft.html">resume, Dom inserted html</a></li>
			<li><a href="./roughdrafting/styles-roughdraft.css">styles</a></li>
